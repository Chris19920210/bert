...
class AsyncAppBertHandler(MyAppBaseHandler):
    global logger
    ...
    def get(self):
        ...
        res = yield gen.Task(bert_align_tasks_enzh.alignment.apply_async, args=[self.request.body])
        ret = res.result
        self.write(ret)
        logger.info(ret)
        self.finish()
...
if __name__ == '__main__':
    ...
    handler = TimedRotatingFileHandler('align_bert_enzh_logs/alignment_enzh_bert.log', backupCount=30,
